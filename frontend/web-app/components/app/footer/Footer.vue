  ...
  <footer class="footer" v-if="!isMobile">
    <div class="page-container">
      <template v-for="(arr, j) in [[0, 3], [3]]" :key="arr">
        <div class="footer__table" :class="{ socials: j == 1 }">
          <div
          ...
          <div class="footer__table-element footer__socials" v-if="j === 1">
            <div class="footer__title">
              <a href="https://www.instagram.com/threehundredru?igsh=MTAzbGkxeHRqbXd0NA==">
              ...
              <a href="https://t.me/experience3hundred">
              ...
              <a href="https://vk.com/threehundredru">
...
.footer {
  ...
  &__table {
    ...
    &.socials {
      $section: calc((4.5fr - 0.9fr - 1.1fr) / 2);
      grid-template-columns: 0.9fr 1.1fr $section $section;
    }
  }
