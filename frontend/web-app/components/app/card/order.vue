  ...
  <div class="order-card container">
    ...
    <div class="order-card__header">
      ...
      <div class="order-card__btns">
        <q-btn v-if="trakNumber" flat class="order-card__btn-search">
          <svg
            width="1.4rem"
            viewBox="0 0 16 16"
            fill="none"
          ...
          >
            <path
              d="M12.3049 12.3049L15 15M14.2222 7.63347C14.2222 11.297 11.2623 14.2669 7.61111 14.2669C3.9599 14.2669 1 11.297 1 7.63347C1 3.9699 3.9599 1 7.61111 1C11.2623 1 14.2222 3.9699 14.2222 7.63347Z"
              stroke="black"
              stroke-width="2"
        ...
        >
          ...
          ></div>
          <span style="margin-left: 1rem">{{ statuses.find((el) => el.id === status).title }}</span>
        </div>
      </div>
    </div>
    ...
    <div class="order-card__info">
      ...
      <svg @click="navigateTo('/profile/order/' + orderId)" width="1.2rem" height="2.4rem" viewBox="0 0 14 26" fill="none" xmlns="http://www.w3.org/2000/svg">
